...
arduinoGenerator.forBlock["array_set_element"] = function (block) {
  const size =
    arduinoGenerator.valueToCode(block, "SIZE", arduinoGenerator.ORDER_NONE) ||
    "null";
  const value =
...
arduinoGenerator.forBlock["array_put_element"] = function (block, generator) {
  ...
  const index =
    generator.valueToCode(block, "INDEX_INPUT", generator.ORDER_NONE) || "0";
  const value =
    generator.valueToCode(block, "VALUE_INPUT", generator.ORDER_NONE) || "0";
