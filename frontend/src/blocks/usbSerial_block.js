...
Blockly.Blocks["serial_begin"] = {
  init: function () {
    ...
    this.setTooltip(
      "Initialize Serial at the given baud rate (goes into setup)."
    );
    this.setHelpUrl("");
  },
};
...
Blockly.Blocks["serial_available"] = {
  /*************  ✨ Windsurf Command ⭐  *************/
  /**
   * Block to get the number of bytes available for reading from Serial.
   * @this Blockly.Block
   */
  /*******  8128fcea-358c-4f7f-8db6-d43d84e63f1d  *******/
  init: function () {
...
Blockly.Blocks["serial_read"] = {
  init: function () {
    this.appendDummyInput().appendField("Serial read byte");
...
Blockly.Blocks["serial_readstring"] = {
  init: function () {
    ...
    this.setColour(160);
    this.setTooltip(
      "Reads characters from Serial until timeout or until newline if checked."
    );
    this.setHelpUrl(
...
Blockly.Blocks["serial_parsefloat"] = {
  init: function () {
    ...
    this.setColour(230);
    this.setTooltip(
      "Parses a float directly or using atof with Serial.readStringUntil."
    );
    this.setHelpUrl(
...
Blockly.Blocks["usbserial_print"] = {
  init: function () {
    this.appendValueInput("VALUE")
      .setCheck("Number")
      .appendField("Software serial print from;");
    this.appendDummyInput()
      .appendField("format")
